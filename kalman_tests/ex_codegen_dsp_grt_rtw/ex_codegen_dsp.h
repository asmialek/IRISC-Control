...
typedef struct {
  dspcodegen_FIRFilter_ex_codeg_T gobj_0;/* '<Root>/Lowpass Filter' */
  dspcodegen_FIRFilter_ex_codeg_T gobj_1;/* '<Root>/Lowpass Filter' */
 ...
 * External functions *
 *====================*/
extern ex_codegen_dsp_rtModel *ex_codegen_dsp(void);
